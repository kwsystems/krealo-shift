 ...
 */
export default function ManagerHoursScreen() {
    ...
    <AppScreen tone="canvas" scroll>
      <ResponsiveContainer>
        <Stack gap={spacing.lg}>
          <AppText variant="title">{t('timesheet.title')}</AppText>
          <EmptyState title={t('timesheet.noEntries')} body={t('states.emptyTitle')} />
        </Stack>
      </ResponsiveContainer>
    </AppScreen>
  );
